...
=======
		...
		<div class="collapse navbar-collapse">
			<ul class="navbar-nav">
				<li class="nav-item active">
					<a class="nav-link" href="report">Personal report
						<span class="sr-only">(current)</span>
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="report/add">Report Add
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="project">Project managerment
					</a>
				</li>
				<li class="nav-item">
	...
	<!-- /.menu -->
>>>>>>> 58f3f681692d20c42965a9cc14925445397ffb39
