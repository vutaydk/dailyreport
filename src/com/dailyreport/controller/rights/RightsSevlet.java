package com.dailyreport.controller.rights;
...
import com.dailyreport.dao.RightsDao;
...
public class RightsSevlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("listRights", rightsDao.get());
